  ...
  <div class="main">
    ...
    <div class="container a-container" id="a-container" :class="{ 'is-txl': !isSignUpMode }">
      <form class="form" id="a-form" @submit.prevent="handleSignUp">
        ...
        <input class="form__input" type="text" placeholder="Name" v-model="signUpForm.name">
        <input class="form__input" type="email" placeholder="Email" v-model="signUpForm.email">
        <input class="form__input" type="password" placeholder="Password" v-model="signUpForm.password">
    ...
    <div class="container b-container" id="b-container" :class="{ 'is-txl is-z200': isSignUpMode }">
      <form class="form" id="b-form" @submit.prevent="handleSignIn">
        ...
        <input class="form__input" type="email" placeholder="Email" v-model="signInForm.email">
        <input class="form__input" type="password" placeholder="Password" v-model="signInForm.password">
...
export default {
  ...
  methods: {
    ...
    handleSignIn() {
      ...
      // Emit event or call API
      this.$emit('sign-in', this.signInForm)
    }
  }
}
</script>
